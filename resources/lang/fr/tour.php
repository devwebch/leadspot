...
return [
    ...
    'intro' => [
        ...
        'intro_2_title'     => "Limite mensuelle",
        'intro_2_text'      => "Selon votre type de compte (gratuit ou payant), votre limite mensuelle peut varier.<br>Cette limite est remise à zéro chaque début de mois.",
        'intro_3_title'     => "Prospects",
        'intro_3_text'      => "Vos derniers prospects seront affichés ici.",
        'intro_4_title'     => "Contactez-nous",
        'intro_4_text'      => "Si vous avez une question ou rencontrez un problème, n'hésitez pas à nous contacter.",
        'intro_4_btn_label'      => "Continuer",
    ],
    'search' => [
        ...
        'search_5_text'      => "Cliquez sur le bouton <em>analyser</em> et les résultats pertinents s'afficheront ici.",
        'search_5_btn_label'      => "Je suis prêt !",
    ]
